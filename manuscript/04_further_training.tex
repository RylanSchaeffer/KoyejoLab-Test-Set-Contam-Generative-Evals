...
\section{Post-Training: Overtraining \& Supervised Finetuning}
\label{sec:further_training}

After pretraining, models typically undergo additional training before deployment.
We now examine how two common post-training interventions---overtraining on fresh data and supervised finetuning---interact with pretraining contamination.
