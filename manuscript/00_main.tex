...
\begin{abstract}
    ...
    Performance improves with contamination and model size.
    ...
    We then study additional training: overtraining with fresh data reduces the effects of contamination, whereas supervised finetuning on the training set will increase performance for low contamination but decrease performance for high contamination.
