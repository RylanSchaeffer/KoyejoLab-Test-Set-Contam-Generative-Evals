...
We conjecture that during SFT, contaminated models learn to generalize, but also forget their contaminated pretraining data, and the effects of contamination are more impactful than generalization for small models, leading to a net increase in test loss; to confirm this, teacher-forced evaluation of SFT checkpoints on perturbed MATH (novel problems never seen during pretraining or SFT) shows SFT lowers NLL at 17/17 conditions, by up to $2.18$ nats, demonstrating improved generalization.
