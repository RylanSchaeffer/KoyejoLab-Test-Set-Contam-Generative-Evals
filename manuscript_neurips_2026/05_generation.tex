...
These three regimes describe idealized asymptotic dynamics rather than sharp boundaries, and should be empirically validated before being used as detection criteria.
