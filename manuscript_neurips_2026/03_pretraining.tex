...
\begin{wraptable}{r}{0.55\textwidth}  % {r} = right side, {0.5\textwidth} = width
    \centering
    \begin{tabular}{crrr}
        \toprule
        ...
        \bottomrule
    \end{tabular}
    \caption{\textbf{Contamination-Driven Performance Is Memorization, Not Generalization.} When MATH test problems are rephrased or perturbed, model performance collapses to baseline regardless of contamination level or model size. Results were consistent across all model sizes.}
