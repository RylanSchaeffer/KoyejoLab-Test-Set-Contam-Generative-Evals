...
% \usepackage{icml2026_fogen} with \usepackage[nohyperref]{icml2026_fogen} above.
\usepackage{hyperref}
...
% For preprint, use
% \usepackage[preprint]{icml2026_fogen}

% If accepted, instead use the following line for the camera-ready submission:
% \usepackage[accepted]{icml2026_fogen}
...
\icmltitlerunning{Submission and Formatting Instructions for FoGen Workshop at ICML 2026}

\begin{document}

\twocolumn[
  \icmltitle{Submission and Formatting Instructions for \\
    the FoGen Workshop at ICML 2026}
...
Submission to the FoGen Workshop at ICML 2026 will be entirely electronic, via a web site
(not email). Information about the submission process and \LaTeX\ templates
are available on the conference web site at:
\begin{center}
  \scriptsize\texttt{https://fdgm-workshop.github.io/FDGM\_ICML2026/}
\end{center}
...
The footnote, ``Preliminary work. Under review by the FoGen Workshop at ICML 2026. Do not distribute.'' must be
modified to ``\textit{Published as a paper at the
  $\mathit{1}^{st}$ FoGen workshop at ICML 2026},
Seoul, South Korea, 2026.
Copyright 2026 by the author(s).''

For those using the \textbf{\LaTeX} style file, this change (and others) is
handled automatically by simply changing
$\mathtt{\backslash usepackage\{icml2026\_fogen\}}$ to
$$\mathtt{\backslash usepackage[accepted]\{icml2026\_fogen\}}$$
...
FoGen at ICML uses double-blind review, so author information must not appear. If
you are using \LaTeX\/ and the \texttt{icml2026\_fogen.sty} file, use
...
A sample file with author names is included in the ICML2026 FoGen style file
...
\texttt{icml2026\_fogen.bst} included in the style-file package to obtain this format.
