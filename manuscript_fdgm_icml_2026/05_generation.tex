...
\begin{figure*}[t!]
    \centering
    \includegraphics[width=\linewidth]{figures/14_math_qwen3_pt_math_verify_teacher_forcing/y=nll_and_cumprob_x=token_index_hue=num_replicas_col=model_size_combined.pdf}
