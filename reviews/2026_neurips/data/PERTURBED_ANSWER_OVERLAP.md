...
At 0-shot, the Perturbed column shows a *larger* residual than Rephrased (4.84% vs 2.78% at R >= 100). That ordering is backwards: rephrasing preserves the answer, so regurgitation can still score correct, whereas perturbing changes the answer and regurgitation should score wrong.
...
Regenerate: `./mem_scoring_vs_sampling_env/bin/python scripts/check_perturbed_answer_overlap.py`
